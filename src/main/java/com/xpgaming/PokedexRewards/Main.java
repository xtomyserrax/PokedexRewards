...
@Plugin(id = Main.id, name = Main.name, version = "0.8.2", dependencies = {@Dependency(id = "pixelmon")})
public class Main {
    ...
    public void onGameInitialization(GameInitializationEvent event) {
        ...
        consoleMsg("§f[§6Pokédex§f] §eMade by Xenoyia, with help from MageFX and XpanD.");
